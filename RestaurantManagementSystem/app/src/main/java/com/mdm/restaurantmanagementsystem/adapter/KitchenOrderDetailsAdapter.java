...
public class KitchenOrderDetailsAdapter extends ArrayAdapter<Item>
{
    public KitchenOrderDetailsAdapter(Activity context, ArrayList<Item> items)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            listItemView = LayoutInflater.from(getContext()).inflate(R.layout.kitchen_order_details_list, parent, false);
        }
