...
public class KitchenOrdersActivity extends AppCompatActivity
{
    ...
    private void getData() //Request information from server
    {
        ...
        Response.Listener<String> responseListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try
                {
                    ...
                    Log.v("Kitchen Orders Activity","Orders list successfully pulled.");
                    loading.dismiss();
                    showJSON(response);
                }
        ...
        ordersRequest retriveOrders = new ordersRequest(responseListener);
        RequestQueue queue = Volley.newRequestQueue(KitchenOrdersActivity.this);
    ...
    private void showJSON(String response) //Display menu from JSON response
    {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Log.v("KitchenOrderActivity", "Order selected: " + orderId);

                Intent intent = new Intent(KitchenOrdersActivity.this, KitchenOrderDetailsActivity.class);
                intent.putExtra("orderId", orderId);
                intent.putExtra("totalPrice",totalPrice);
                KitchenOrdersActivity.this.startActivity(intent);
            }
        });
    }
}